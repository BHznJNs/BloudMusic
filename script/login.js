...
const { get_user } = require("../.BloudMusic_modules/get_user")
const { save_data } = require("../.BloudMusic_modules/operate_file")
const { make_dir } = require("../.BloudMusic_modules/operate_dir")
const { get_pl, filter_pl } = require("../.BloudMusic_modules/operate_playlist")
const { collected_art, followed_art } = require("../.BloudMusic_modules/get_artists")
...
async function to_login() {
    ...
    try {
        ...
        let cookie = user_data.cookie
        let follows = user_data.follows
    } catch {
        alert("用户资料请求错误！")
        hide_load()
    }
